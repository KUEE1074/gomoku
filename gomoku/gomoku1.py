    ...
    for i in range(19):
        ...
        if goban[y-1][left] == goban[y-1][i]:
            if goban[y-1][i] == 'O':
                hori_count[0] += 1
                if i == 18:
                    heuristic[y-1][left-1][0] = max(heuristic[y-1][left-1][0], 10**hori_count[0] / 2)           
            if goban[y-1][i] == 'X':
                hori_count[1] += 1
                if i == 18:
                    heuristic[y-1][left-1][1] = max(heuristic[y-1][left-1][1], 10**hori_count[1] / 2)    
        else:
            if left > 0:
                if goban[y-1][left-1] == 0:       
                    if goban[y-1][left] =='O' and hori_count[0] < 5:
                        if goban[y-1][i] == 0:
                            heuristic[y-1][left-1][0] = max(heuristic[y-1][left-1][0], 10**hori_count[0])    
                        elif goban[y-1][i] == 'X':
                            heuristic[y-1][left-1][0] = max(heuristic[y-1][left-1][0], 10**hori_count[0] / 2)     
                    elif goban[y-1][left]=='X' and hori_count[1] < 5:
                        if goban[y-1][i] == 0:
                            heuristic[y-1][left-1][1] = max(heuristic[y-1][left-1][1], 10**hori_count[1])    
                        elif goban[y-1][i] == 'O':
                            heuristic[y-1][left-1][1] = max(heuristic[y-1][left-1][1], 10**hori_count[1] / 2)    
            ...
            if goban[y-1][i] == 0:
                if goban[y-1][left] == 'O' and hori_count[0] < 5:
                    if left == 0:
                        heuristic[y-1][i][0] = max(heuristic[y-1][i][0], 10**hori_count[0] / 2)    
                        left = i
                        hori_count = [0, 0]
                        continue
                    if goban[y-1][left-1] == 0:
                        heuristic[y-1][i][0] = max(heuristic[y-1][i][0], 10**hori_count[0])
                    elif goban[y-1][left-1] == 'X':
                        heuristic[y-1][i][0] = max(heuristic[y-1][i][0], 10**hori_count[0] / 2)
                elif goban[y-1][left] == 'X'and hori_count[1] < 5:
                    if left == 0:
                        heuristic[y-1][i][1] = max(heuristic[y-1][i][1], 10**hori_count[1] / 2)
                        left = i
                        hori_count = [0, 0]
                        continue
                    if goban[y-1][left-1] == 0:
    ...
    for i in range(19):
        ...
        if goban[top][x-1] == goban[i][x-1]:
            if goban[i][x-1] == 'O':
                verti_count[0] += 1
                if i == 18:
                    heuristic[top-1][x-1][0] = max(heuristic[top-1][x-1][0], 10**verti_count[0] / 2)        
            if goban[i][x-1] == 'X':
                verti_count[1] += 1
                if i == 18:
                    heuristic[top-1][x-1][1] = max(heuristic[top-1][x-1][1], 10**verti_count[1] / 2)
        else:
            if top > 0:
                if goban[top-1][x-1] == 0:      
                    if goban[top][x-1] == 'O' and verti_count[0] < 5:
                        if goban[i][x-1] == 0 : 
                            heuristic[top-1][x-1][0] = max(heuristic[top-1][x-1][0], 10**verti_count[0])
                        elif goban[i][x-1] == 'X':
                            heuristic[top-1][x-1][0] = max(heuristic[top-1][x-1][0], 10**verti_count[0] / 2)
            ...
            if goban[i][x-1] == 0:
                if goban[top][x-1] == 'O' and verti_count[0] < 5:
                    if top == 0:
                        heuristic[i][x-1][0] = max(heuristic[i][x-1][0], 10**verti_count[0] / 2)
                        verti_count = [0, 0]
                        top = i
                        continue
                    if goban[top-1][x-1] == 0:
                        heuristic[i][x-1][0] = max(heuristic[i][x-1][0], 10**verti_count[0])
                    elif goban[top-1][x-1] == 'X':
                        heuristic[i][x-1][0] = max(heuristic[i][x-1][0], 10**verti_count[0] / 2)    
                elif goban[top][x-1] == 'X' and verti_count[1] < 5:
                    if top == 0:
                        heuristic[i][x-1][1] = max(heuristic[i][x-1][1], 10**verti_count[1] / 2)
                        verti_count = [0, 0]
                        top = i
                        continue
                    if goban[top-1][x-1] == 0:
                        heuristic[i][x-1][1] = max(heuristic[i][x-1][1], 10**verti_count[1])
                    elif goban[top-1][x-1] == 'O':
                        heuristic[i][x-1][1] = max(heuristic[i][x-1][0], 10**verti_count[0] / 2)
                verti_count = [0, 0]
                top = i
            else:
                top = i
    ...
    while True:
        ...
        if goban[diag1_y][diag1_x] == goban[j][i]:
            if goban[j][i] == 'O':
                diag1_count[0] += 1
                if i == 18 or j == 0:
                    heuristic[diag1_y+1][diag1_x-1][0] = max(heuristic[diag1_y+1][diag1_x-1][0], 10**diag1_count[0] / 2)
            if goban[j][i] == 'X':
                diag1_count[1] += 1
                if i == 18 or j == 0:
                    heuristic[diag1_y+1][diag1_x-1][1] = max(heuristic[diag1_y+1][diag1_x-1][1], 10**diag1_count[1] / 2)
        else:
            if diag1_x > 0 and diag1_y < 18:
                if goban[diag1_y+1][diag1_x-1] == 0:      
                    if goban[diag1_y][diag1_x] == 'O' and diag1_count[0] < 5:
                        if goban[j][i] == 0 : 
                            heuristic[diag1_y+1][diag1_x-1][0] = max(heuristic[diag1_y+1][diag1_x-1][0], 10**diag1_count[0])
                        elif goban[j][i] == 'X':
                            heuristic[diag1_y+1][diag1_x-1][0] = max(heuristic[diag1_y+1][diag1_x-1][0], 10**diag1_count[0] / 2)
                    elif goban[diag1_y][diag1_x] == 'X' and diag1_count[1] < 5:
                        if goban[j][i] == 0 : 
                            heuristic[diag1_y+1][diag1_x-1][1] = max(heuristic[diag1_y+1][diag1_x-1][1], 10**diag1_count[1])
                        elif goban[j][i] == 'O':
                            heuristic[diag1_y+1][diag1_x-1][1] = max(heuristic[diag1_y+1][diag1_x-1][1], 10**diag1_count[1] / 2)
            if goban[j][i] == 0:
                if goban[diag1_y][diag1_x] == 'O' and diag1_count[0] < 5:
                    if diag1_y == 18 or diag1_x == 0:
                        heuristic[j][i][0] = max(heuristic[j][i][0], 10**diag1_count[0] / 2)
                        diag1_count = [0, 0]
                        diag1_x = i
                        diag1_y = j
                        continue
                    if goban[diag1_y+1][diag1_x-1] == 0:
                        heuristic[j][i][0] = max(heuristic[j][i][0], 10**diag1_count[0])
                    elif goban[diag1_y+1][diag1_x-1] == 'X':
                        heuristic[j][i][0] = max(heuristic[j][i][0], 10**diag1_count[0] / 2)    
                elif goban[diag1_y][diag1_x] == 'X' and diag1_count[1] < 5:
                    if diag1_y == 18 or diag1_x == 0:
                        heuristic[j][i][1] = max(heuristic[j][i][1], 10**diag1_count[1] / 2)
                        diag1_count = [0, 0]
                        diag1_x = i
                        diag1_y = j
                        continue
    ...
    while True:
        ...
        if goban[diag2_y][diag2_x] == goban[j][i]:
            if goban[j][i] == 'O' :
                diag2_count[0] += 1
                if i == 18 or j == 18:
                    heuristic[diag2_y-1][diag2_x-1][0] = max(heuristic[diag2_y-1][diag2_x-1][0], 10**diag2_count[0] / 2)
            if goban[j][i] == 'X':
                diag2_count[1] += 1
                if i == 18 or j == 18:
                    heuristic[diag2_y-1][diag2_x-1][1] = max(heuristic[diag2_y-1][diag2_x-1][1], 10**diag2_count[1] / 2)
        else:
            if diag2_x > 0:
                if goban[diag2_y-1][diag2_x-1] == 0:      
                    if goban[diag2_y][diag2_x] == 'O' and diag2_count[0] < 5:
                        if goban[j][i] == 0: 
                            heuristic[diag2_y-1][diag2_x-1][0] = max(heuristic[diag2_y-1][diag2_x-1][0], 10**diag2_count[0])
                        elif goban[j][i] == 'X':
                            heuristic[diag2_y-1][diag2_x-1][0] = max(heuristic[diag2_y-1][diag2_x-1][0], 10**diag2_count[0] / 2)
                    elif goban[diag2_y][diag2_x] == 'X' and diag2_count[1] < 5:
                        if goban[j][i] == 0: 
                            heuristic[diag2_y-1][diag2_x-1][1] = max(heuristic[diag2_y-1][diag2_x-1][1], 10**diag2_count[1])
                        elif goban[j][i] == 'O':
                            heuristic[diag2_y-1][diag2_x-1][1] = max(heuristic[diag2_y-1][diag2_x-1][1], 10**diag2_count[1] / 2)
            if goban[j][i] == 0:
                if goban[diag2_y][diag2_x] == 'O' and diag2_count[0] < 5:
                    if diag2_x == 0 or diag2_y == 0:
                        heuristic[j][i][0] = max(heuristic[j][i][0], 10**diag2_count[0] / 2)
                        diag2_count = [0, 0]
                        diag2_x = i
                        diag2_y = j
                        continue
                    if goban[diag2_y-1][diag2_x-1] == 0:
                        heuristic[j][i][0] = max(heuristic[j][i][0], 10**diag2_count[0])
                    elif goban[diag2_y-1][diag1_x-1] == 'X':
                        heuristic[j][i][0] = max(heuristic[j][i][0], 10**diag2_count[0] / 2)    
                elif goban[diag2_y][diag2_x] == 'X' and diag2_count[1] < 5:
                    if diag2_x == 0 or diag2_y == 0:
                        heuristic[j][i][1] = max(heuristic[j][i][1], 10**diag2_count[1] / 2)
                        diag2_count = [0, 0]
                        diag2_x = i
                        diag2_y = j
                        continue
...
def Ai_turn(goban, heuristic, sett): ##alpha_beta_pruning: return이 좌표여야함
    ...
    for limit in range(1, depth_limit, 2):
        ...
        print("함수 발생 횟수 : ", function_count)
        if temp[2] == invalid_value:
            break
        if limit == 1:
            result = temp
            continue
        if result[0] != temp[0] or result[1] != temp[1]:
            result = temp
        function_count = 0
...
def black_value(goban, m_heuristic, sett, state, alpha, beta, depth, limit):
    ##print(alpha, beta)
    global function_count, invalid_value, start_time, time_limit
    function_count += 1
    depth += 1
...
def white_value(goban, m_heuristic, sett, state, alpha, beta, depth, limit):
    global function_count, invalid_value
    function_count += 1
    depth += 1
    my_goban = deepcopy(goban)
    my_heuristic = deepcopy(m_heuristic)
    ...
    if depth == limit:
        ...
        min_move = [0, 0]
        for (i, j) in my_set:
            if my_heuristic[j][i][0] + my_heuristic[j][i][1] < min_value:
                min_value = my_heuristic[j][i][0] + my_heuristic[j][i][1]
                min_move = [i, j]
        min_move.append(min_value)
        return min_move
    lst = []
    result = [0, 0, INF]
    for k in range(int(len(my_set)/4)):
...
##나중에 핸즈 대회 하게되면 heuristic 먼저 손봐야할듯?
##우선 너무 멍청함